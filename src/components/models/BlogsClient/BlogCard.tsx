      ...
      <div className='p-6'>
        ...
        <div className='flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 mb-3'>
          <div className='flex items-center gap-1'>
            ...
            <span>{blog?.createdAt ? format(blog.createdAt) : ''}</span>
          </div>
          <div className='flex items-center gap-1'>
        ...
        {/* Description */}
        <p className='text-gray-650 dark:text-gray-300 text-sm mb-4 line-clamp-3 leading-relaxed'>
          {blog?.description}
        </p>
        ...
        {blogTags.length > 0 && (
          <div className='flex flex-wrap gap-2 mb-4'>
            {blogTags.slice(0, 3).map((tag, index) => (
              <span
                key={index}
                className='px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-655 dark:text-gray-300 text-xs rounded-md'
              >
                #{tag}
              </span>
            ))}
