              ...
              >
                ...
                >
                  ...
                  <div className='p-6 flex flex-col flex-1 space-y-4'>
                    ...
                    {project?.technologies && project.technologies.length > 0 && (
                      <div className='flex flex-wrap gap-1.5 pt-2'>
                        ...
                        {project.technologies.length > 4 && (
                          <span className='px-2.5 py-1 bg-gray-50 dark:bg-gray-800 text-gray-455 dark:text-gray-500 text-[10px] font-bold rounded-lg border border-gray-150 dark:border-gray-700/50'>
                            +{project.technologies.length - 4}
                          </span>
                        )}
                      </div>
                    ...
                    {/* Card Footer */}
                    <div className='flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-808 mt-auto'>
                      <Link
                        ...
                        <div className='flex items-center gap-3'>
                          ...
                          {project?.githubUrl && (
                            <Link
                              ...
                              target='_blank'
                              className='text-gray-455 hover:text-blue-600 dark:text-gray-500 dark:hover:text-blue-400 transition-colors'
